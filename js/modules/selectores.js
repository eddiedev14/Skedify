...
//* Avatar Modal
export const modalBtn = document.querySelector("#change-avatar");
export const modal = document.querySelector("#avatar-modal");
...
export const modalSubmitBtn = document.querySelector("#update-avatar");